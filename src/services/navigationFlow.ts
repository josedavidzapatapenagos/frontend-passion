import { AUTH_SESSION_KEY, normalizeAccountType } from "./authService";

export type AccountType = "USER" | "MODEL" | "ADMIN" | "SUPER_ADMIN";
...
export const readAuthState = (): AuthState => {
  ...
  return {
    ...
    accountType: normalizeAccountType(localStorage.getItem("accountType")) as AccountType | null,
  };
};
