...
const readBackendMessage = (error: unknown): string => {
  ...
  const candidates = [data?.message, data?.detail, data?.title];
      ...
      content: (
        <section className="rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-100/80 dark:bg-white/5 p-4">
          ...
          <button
            ...
            className="mt-4 w-full rounded-2xl border border-[#00BCD4] bg-cyan-50/80 px-5 py-3 text-sm font-bold uppercase tracking-wide text-cyan-800 transition hover:bg-cyan-100 disabled:cursor-not-allowed disabled:opacity-60 dark:border-[#00BCD4]/70 dark:bg-[#00BCD4]/10 dark:text-cyan-200 dark:hover:bg-[#00BCD4]/20"
          >
            Subir fotos
          </button>
        </section>
