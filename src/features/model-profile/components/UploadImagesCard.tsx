...
import { uploadModelProfileImagesApi } from "@/features/model-profile/services/modelProfileService";
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        {hasFiles && (
          <button
            ...
            disabled={isUploading || isLoading}
            className="rounded-xl bg-[#FD0083] px-5 py-3 text-sm font-black uppercase tracking-wide text-white transition hover:bg-[#e40076] disabled:cursor-not-allowed disabled:opacity-60"
          >
            {files.length === 1 ? "Subir foto" : "Subir fotos"}
          </button>
        )}
